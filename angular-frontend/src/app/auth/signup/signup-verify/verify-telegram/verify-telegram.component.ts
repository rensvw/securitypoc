...
@Component({
  selector: 'app-verify-telegram',
  templateUrl: './verify-telegram.component.html',
  styleUrls: ['./verify-telegram.component.css']
})
export class SignupVerifyTelegramComponent implements OnInit {
